Proceso hospital
	...
	//algoritmo: Obtener que parte del presupuesto le toca a cada seccion del hospital  
	...
	SiNo
		escribir "El presupuesto del hospital no puede ser negativo,por favor intente de nuevo "
	Fin Si
